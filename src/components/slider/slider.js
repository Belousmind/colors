...
function showSlide(index) {
  const slides = document.querySelectorAll(".category-hero__slide-image");
  const dots = document.querySelectorAll(".category-hero__dot");
...
document
  .querySelector(".category-hero__nav--prev")
...
document
  .querySelector(".category-hero__nav--next")
  .addEventListener("click", () => {
    const totalSlides = slidesData.length;
...
dotsContainer.addEventListener("click", (e) => {
  if (e.target.classList.contains("category-hero__dot")) {
